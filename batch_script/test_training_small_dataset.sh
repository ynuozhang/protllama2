...
#PBS -l select=1:ncpus=64:mem=300g:ngpus=2
#PBS -keo
...
python3.8 /data/rozen/home/e0833634/lama/protllama/bin/test_training_small_dataset.py > Oct12_test_training.log 2>&1
