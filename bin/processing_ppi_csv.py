...
params = parse_args()
df1 = pd.read_csv(f'{params.input_csv_path}/clusters_80.csv')
df2 = pd.read_csv(f'{params.input_csv_path}/clusters_20.csv')
#df3 = pd.read_csv(f'{params.input_csv_path}/ppigpt_test_merged_bernett_goldstandard_nov27_2023.csv')

seq1_train = df1['seq_1'].values.tolist()
seq2_train = df1['seq_2'].values.tolist()
seq1_valid = df2['seq_1'].values.tolist()
seq2_valid = df2['seq_2'].values.tolist()
...
print(dataset_dict)
dataset_dict.save_to_disk(f'{params.output_dataset_path}/ppi_noisy_raw.hf')